...
var (
	...
	argSubscriptionName        = flag.String("subid", "my-iot-356305", "Subscription name of kore client")
	...
	argTimeout                 = flag.String("timeout", "60s", "Timeout for pub/sub actions")
	argGlobalTimeout           = flag.String("global-timeout", "200s", "Timeout spanning all operations")
	...
	subscriberClientIdTemplate = fmt.Sprintf("subscriptions/%s/registries/test123/devices/StateManager", *argSubscriptionName) + "%d"
	publisherClientIdTemplate  = fmt.Sprintf("subscriptions/%s/registries/test123/devices/Stresser", *argSubscriptionName) + "%d"
	topicNameTemplate          = fmt.Sprintf("subscriptions/%s/registries/test123/devices/Stresser", *argSubscriptionName) + "%d/events"
)
